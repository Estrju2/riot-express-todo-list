...
function transferProjectToRemote(failed, successful) {
  return ssh.putDirectory(
    '../riot-wxpress-todo-list',
    '/home/ubuntu/riot-wxpress-todo-list-temp',
    {
      recursive: true,
      concurrency: 1,
...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf riot-wxpress-todo-list-temp && mkdir riot-wxpress-todo-list-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir riot-wxpress-todo-list && cp -r riot-wxpress-todo-list-temp/* riot-wxpress-todo-list/ && rm -rf riot-wxpress-todo-list-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd riot-wxpress-todo-list && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function() {
      console.log('Creating `riot-wxpress-todo-list-temp` folder.');
